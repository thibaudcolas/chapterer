        ...
        figure_markup: [
          {
            ...
            caption_2023: "Pages with zooming and scaling disabled.",
            description_2021:
          ...
          },
          {
            ...
            caption_2023: "Pages with zooming and scaling disabled by rank.",
            description_2021:
        ...
        figure_markup: [
          {
            ...
            caption_2023: "Mobile sites have a valid `lang` attribute.",
            content_2021: "80.5%",
            content_2022: "82.7%",
        ...
        figure_markup: [
          {
            ...
            caption_2023: "Pages overriding focus styles.",
            description_2021:
          ...
          },
          {
            ...
            sql_file_2023: "focus_visible.sql",
            status: "TODO",
          },
        ],
        children: null,
        ...
        figure_markup: [
          {
            ...
            caption_2023: "User preference media queries.",
            description_2021:
        ...
        figure_markup: [
          {
            ...
            caption_2023: "Title element statistics",
            description_2021:
        ...
        figure_markup: [
          {
            ...
            caption_2023: "Mobile sites using a CAPTCHA",
            content_2021: "10.2%",
            content_2022: "18.5%",
            classes_2021: "big-number",
            classes_2022: "big-number",
        ...
        figure_markup: [
          {
            ...
            caption_2023: "Where inputs get their accessible names from.",
            description_2021:
        ...
        figure_markup: [
          {
            ...
            caption_2023: "Use of placeholders on inputs.",
            description_2021:
        ...
        figure_markup: [
          {
            ...
            caption_2023: "How required inputs are specified",
            description_2021:
        ...
        children: [
          {
            ...
            figure_markup: [
              ...
              },
              {
                ...
                caption_2023: "Most common file extensions in `alt` text.",
                description_2021:
              ...
              },
              {
                ...
                caption_2023: "`alt` attribute lengths.",
                description_2021:
        ...
        figure_markup: [
          {
            ...
            caption_2023: "Number of ARIA roles used by percentile.",
            description_2021:
          ...
          },
          {
            ...
            caption_2023: "Top 10 most common ARIA roles.",
            description_2021:
        ...
        figure_markup: [
          {
            ...
            caption_2023: "Top 10 ARIA attributes.",
            description_2021:
            ...
            figure_markup: [
              {
                ...
                caption_2023: "Button accessible name source.",
                description_2021:
    ...
    figure_markup: [
      {
        ...
        caption_2023: "Pages using accessibility apps.",
        description_2021:
      ...
      },
      {
        ...
        caption_2023: "Accessibility app usage by rank.",
        description_2021:
      ...
      },
      {
        ...
        caption_2023: "Pages using accessibility apps by rank.",
        description_2021:
  ...
  return figures.flatMap((figure) => {
    return [
      ...
      [
        ...
        figure.image_2023 || "",
        // "Image URL",
        figure.image_2023 ? `${IMG_2023}/${figure.image_2023}` : "",
        // "Caption",
        figure.caption_2023 || "",
        // "Description",
        figure.description_2023 || "",
        // "Chart URL",
        figure.chart_url_2023 || "",
        // "Sheets Title",
        figure.sheets_title || "",
        // "Sheets GID",
        figure.sheets_gid_2023 || "",
        // "Sheets URL",
        figure.sheets_gid_2023
          ? `${SHEET_2023}#gid=${figure.sheets_gid_2023}`
          : "",
        // "SQL file",
        figure.sql_file_2023 || "",
        // "SQL file URL",
        figure.sql_file_2023 ? `${SQL_2023}/${figure.sql_file_2023}` : "",
        // "Content",
        figure.content_2023 || "",
        // "Classes",
        figure.classes_2023 || "",
...
function generateFigures(cat) {
  cat.figure_markup?.forEach((fig) => {
    const url = `${SHEET_2023}#gid=${fig.sheets_gid_2023}`;

    if (fig.content_2023) {
      figures.push(`\`\`\`
{{ figure_markup(
  content="${fig.content_2023}",
  caption="${fig.caption_2023}",
  classes="${fig.classes_2023}",
  sheets_gid="${fig.sheets_gid_2023}",
  sql_file="${fig.sql_file_2023}",
) }}
\`\`\`

// [${fig.sheets_title}](${url}), [${fig.sql_file_2023}](${SQL_2023}/${fig.sql_file_2023})
`);
    } else {
      const width = fig.width_2023 ? `\n  width="${fig.width_2023}",` : "";
      const height = fig.height_2023 ? `\n  height="${fig.height_2023}",` : "";

      figures.push(`\`\`\`
{{ figure_markup(
  image="${fig.image_2023}",
  caption="${fig.caption_2023}",
  description="${fig.description_2023}",
  chart_url="${fig.chart_url_2023}",
  sheets_gid="${fig.sheets_gid_2023}",
  sql_file="${fig.sql_file_2023}",${width}${height}
) }}
\`\`\`
